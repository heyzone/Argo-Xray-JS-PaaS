...
# 设置各变量
WSPATH=${WSPATH:-'argo'}
UUID=${UUID:-'d2ac1100-2c2a-480a-8e2c-835136872fb1'}

NEZHA_SERVER= # 哪吒三个参数，不需要的话可以留空，删除或在这三行最前面加 # 以注释
NEZHA_PORT=
NEZHA_KEY=2

ARGO_AUTH='eyJhIjoiNTk5MzUwOTkyOTQzNmJkYzVhNTdmYjJmN2Y5YTlkMjAiLCJ0IjoiOGU5NDYzMTUtMDEyMy00NjRmLTkwMDctODg0ZWU1NTZkZDRjIiwicyI6Ik1ETm1PVFppTmpndFpqY3dNeTAwTXpRd0xUaGpNVEF0T1Rnd1lXWTFOREZrTVdFdyJ9' # Argo 固定域名隧道的两个参数,这个可以填 Json 内容或 Token 内容，获取方式看 https://github.com/fscarmen2/X-for-Glitch，不需要的话可以留空，删除或在这三行最前面加 # 以注释
ARGO_DOMAIN=glit.heyzone.eu.org
